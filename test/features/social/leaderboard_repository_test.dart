...
void main() {
  ...
  test(
    'Bayesian sort keeps a thinly-rated 5.0 below a heavily-rated 4.5',
    () async {
      ...
      expect(
        names.indexOf('ManyFourHalf'),
        lessThan(names.indexOf('OneFiveStar')),
  ...
  test('getLeaderboardByOrigin filters to the requested country', () async {
    ...
    final entries = await repo
        .getLeaderboardByOrigin(originCountry: 'Ethiopia')
        .first;
